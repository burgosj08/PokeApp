  ...
  return (
    <div>
      <div className=" flex flex-col flex-auto flex-shrink-0 antialiased text-gray-800">
        <div className=" fondoNAV fixed flex flex-col top-0 left-0 w-48 md:w-96 h-full shadow-lg">
          <div className="mt-12 flex items-center pl-6 h-20 border-b border-gray-800">
            <img
              src="../../src/public/img/PokeballHeader2.png"
              alt=""
